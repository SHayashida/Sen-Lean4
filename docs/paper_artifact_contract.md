...
| --- | --- | --- | --- | --- | --- | --- |
| `frontier_matrix.tex` | `C1` | `scripts/plot_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_matrix.tex` | `existence` | Yes |
| `frontier_matrix.png` | `C1` | `scripts/plot_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_matrix.png` | `existence` | No |
| `frontier_boundary.tex` | `C1`, `C2` | `scripts/plot_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_boundary.tex` | `existence` | Yes |
| `frontier_boundary.png` | `C1`, `C2` | `scripts/plot_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_boundary.png` | `existence` | No |
...
| `frontier_hasse.tex` | `C1`, `C2` | `scripts/plot_hasse_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_hasse.tex` | `existence` | Yes |
| `frontier_hasse.png` | `C1`, `C4` | `scripts/plot_hasse_frontier.py` | `python3 scripts/render_paper_assets.py --mode full` | `paper/figures/generated/frontier_hasse.png` | `existence` | No |
...
- The paper now uses the dependency-free TeX snippets `frontier_matrix.tex`, `frontier_boundary.tex`, and `frontier_hasse.tex` as the authoritative figure inputs.
- The narrower official `C2` claim remains `one MUS + one small MCS candidate`. The paper uses `frontier_boundary.tex`, `frontier_hasse.tex`, and the per-case `mus.json` / `mcs.json` artifacts for that claim.
- The stronger repair tables belong to `C6`, not `C2`.
- `frontier_hasse.png` is best-effort rendering from `frontier_hasse.dot`; if Graphviz is unavailable, the DOT file and TeX boundary-slice figure remain the primary guaranteed artifacts.
