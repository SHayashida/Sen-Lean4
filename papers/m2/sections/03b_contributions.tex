...
\item We make explicit the Proof-vs-Witness/Audit scope wall.
...
\item We separate this paper's scope from a deferred representation-canonicity question.
  ...
  Accordingly we defer it to a companion paper (in preparation) and treat it here only as a forward pointer (Section~\ref{sec:conclusion}).
\end{itemize}
