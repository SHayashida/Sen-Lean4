\section{The Proof-Layer Lift and Its Witness-Layer Boundary}
\label{sec:theorem}
...
The full proof is checked by the Lean~4 kernel.
...
These are separate questions, addressed in Section~\ref{sec:negative} and deferred to a companion paper (in preparation) respectively.
\end{remark}
...
The Lean Proof-layer theorem named \code{sen_impossibility_lifts} does not automatically upgrade the sen24 CNF atlas into a family-level CNF certificate for full \code{SocialAcyclic}.
