...
Python \code{\_right\_clauses} \(\leftrightarrow\) Lean right-condition
semantics &
Not crossed &
...
bridge: \code{RightAtomSemantics}, orientation invariance, and the sufficient
direction from two fixed right conditions for distinct voters to
