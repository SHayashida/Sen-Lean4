...
\code{MINLIB}. They do not turn the Python/CNF artifacts or the finite
certificate as a whole into Lean-verified artifacts; Section~\ref{sec:limitations}
records the full non-claim list. The bridge therefore supports semantic
discipline without collapsing Level B semantic anchoring into Level C artifact
correctness.
