...
\item \code{_right_clauses} correctness;
...
\item a Lean reconstruction or independent formalization of the finite-audit
  checker obligations.
\end{itemize}
...
The finite audit currently relies on documented checker artifacts and recorded
finite-data evidence. The checker itself is not yet formalized in Lean. A Lean
reconstruction of the checker would be a stronger future assurance step; this
is a future Level C / checker-hardening obligation, not a current M4 claim.
