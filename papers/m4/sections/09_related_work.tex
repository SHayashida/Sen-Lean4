...
direction from two fixed right conditions to \code{MINLIB}. It does not turn
the Python/CNF artifacts into Lean-verified artifacts; Section~\ref{sec:limitations}
records the full non-claim list.
