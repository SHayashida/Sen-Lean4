...
- neutrality_violation_count: `8` / `12`
- pair_constancy_score: `0.6667`
- distinct_social_outcomes: `44`
...
- `p=9` (`r0=[0,1,2,3]`, `r1=[1,2,3,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=10` (`r0=[0,1,2,3]`, `r1=[1,3,0,2]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=11` (`r0=[0,1,2,3]`, `r1=[1,3,2,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
...
- `p=15` (`r0=[0,1,2,3]`, `r1=[2,1,3,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=16` (`r0=[0,1,2,3]`, `r1=[2,3,0,1]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=17` (`r0=[0,1,2,3]`, `r1=[2,3,1,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=18` (`r0=[0,1,2,3]`, `r1=[3,0,1,2]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
- `p=19` (`r0=[0,1,2,3]`, `r1=[3,0,2,1]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 2>3, 3>0
