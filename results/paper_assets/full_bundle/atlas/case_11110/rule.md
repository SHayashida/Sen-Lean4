...
- case_id: `case_11110`
- status: `SAT`
- axioms_on: `asymm, un, minlib, no_cycle3`
- model true vars: `3444` (p-vars: `3440`, aux-vars: `4`)
...
- dictatorship_score_voter0: `0.7419`
- dictatorship_score_voter1: `0.7581`
- neutrality_violation_count: `8` / `12`
- pair_constancy_score: `0.5926`
- distinct_social_outcomes: `28`
...
- `p=9` (`r0=[0,1,2,3]`, `r1=[1,2,3,0]`) -> social edges: 1>0, 1>2, 1>3, 2>0, 2>3, 3>0
- `p=10` (`r0=[0,1,2,3]`, `r1=[1,3,0,2]`) -> social edges: 0>2, 1>0, 1>2, 1>3, 3>0, 3>2
- `p=11` (`r0=[0,1,2,3]`, `r1=[1,3,2,0]`) -> social edges: 0>2, 1>0, 1>2, 1>3, 3>0, 3>2
...
- `p=15` (`r0=[0,1,2,3]`, `r1=[2,1,3,0]`) -> social edges: 1>0, 1>2, 1>3, 2>0, 2>3, 3>0
- `p=16` (`r0=[0,1,2,3]`, `r1=[2,3,0,1]`) -> social edges: 0>1, 1>2, 2>3, 3>0
- `p=17` (`r0=[0,1,2,3]`, `r1=[2,3,1,0]`) -> social edges: 0>1, 1>2, 2>3, 3>0
