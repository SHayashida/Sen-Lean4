...
| `case_01010` | `un,no_cycle3` | 219 | 0.7500 | True |
| `case_01011` | `un,no_cycle3,no_cycle4` | 219 | 0.7500 | True |
...
- equiv_class_id: `eq_0ce87fb418b3960b`
- orbit_size: `1`
- representative_case: `case_01010`
- model_validated: `True`
- non_trivial: `True`
- metrics: distinct=`219`, dict_max=`0.7500`, constant_rate=`0.0000`
- nontriviality: included=`passes_non_triviality_thresholds`, excluded=`(none)`
- files: rule=`case_01010/rule.md`, model=`case_01010/model.json`, rule_card_md=`case_01010/rule_card.md`, rule_card_tex=`case_01010/rule_card.tex`, cnf=`case_01010/sen24.cnf`, manifest=`case_01010/sen24.manifest.json`
...
- equiv_class_id: `eq_b34448ff07cf41e7`
- orbit_size: `1`
- representative_case: `case_01011`
- model_validated: `True`
- non_trivial: `True`
- metrics: distinct=`219`, dict_max=`0.7500`, constant_rate=`0.0000`
- nontriviality: included=`passes_non_triviality_thresholds`, excluded=`(none)`
- files: rule=`case_01011/rule.md`, model=`case_01011/model.json`, rule_card_md=`case_01011/rule_card.md`, rule_card_tex=`case_01011/rule_card.tex`, cnf=`case_01011/sen24.cnf`, manifest=`case_01011/sen24.manifest.json`
