...
- case_id: `case_10101`
- status: `SAT`
- axioms_on: `asymm, minlib, no_cycle4`
- model true vars: `3316` (p-vars: `3312`, aux-vars: `4`)
...
- dictatorship_score_voter0: `0.5903`
- dictatorship_score_voter1: `0.6042`
- neutrality_violation_count: `7` / `12`
- pair_constancy_score: `0.7708`
...
- `p=9` (`r0=[0,1,2,3]`, `r1=[1,2,3,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=10` (`r0=[0,1,2,3]`, `r1=[1,3,0,2]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=11` (`r0=[0,1,2,3]`, `r1=[1,3,2,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
...
- `p=15` (`r0=[0,1,2,3]`, `r1=[2,1,3,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=16` (`r0=[0,1,2,3]`, `r1=[2,3,0,1]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=17` (`r0=[0,1,2,3]`, `r1=[2,3,1,0]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=18` (`r0=[0,1,2,3]`, `r1=[3,0,1,2]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
- `p=19` (`r0=[0,1,2,3]`, `r1=[3,0,2,1]`) -> social edges: 0>1, 0>2, 1>2, 1>3, 3>0, 3>2
